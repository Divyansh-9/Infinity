...
def load_model():
    ...
    try:
        model = joblib.load('anomaly_ensemble_model.pkl')
        threshold = joblib.load('best_threshold.pkl')
        return model, threshold
    except Exception as e:
        st.warning("Model files not found. Please ensure 'anomaly_ensemble_model.pkl' and 'best_threshold.pkl' are in the directory. Using dummy models for demonstration.")
        return None, 0.5
